...
- Terminal bell events now drive session attention state: inactive or hidden sessions show a pending tab marker, notifications are throttled per session, and the marker clears when the session becomes the visible active terminal again.
