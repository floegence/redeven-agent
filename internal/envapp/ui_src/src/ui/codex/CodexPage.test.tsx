  ...
  renderDisposers.push(render(() => (
    <EnvContext.Provider
      value={{
        ...
        activeSurface: () => 'codex',
        lastActivitySurface: () => 'codex',
        openSurface: () => undefined,
        goActivity: () => undefined,
        ...
        consumeWorkbenchOverviewEntry: () => undefined,
        consumeWorkbenchSurfaceActivation: () => undefined,
        workbenchFilePreviewActivationSeq: () => 0,
        workbenchFilePreviewActivation: () => null,
        consumeWorkbenchFilePreviewActivation: () => undefined,
...
describe('CodexPage', () => {
  ...
  it('keeps queue hidden for an empty active draft and ignores empty queue attempts', async () => {
    const startedDetail = {
      thread: {
        id: 'thread_queue_hidden',
        name: 'Queue hidden',
        preview: 'Queue hidden',
        ephemeral: false,
        model_provider: 'gpt-5.4',
        created_at_unix_s: 1,
        updated_at_unix_s: 2,
    ...
    expect(notification.error.mock.calls).toHaveLength(errorCallCount);
