...
- On `release: published`, GitHub Actions mirrors release assets to Cloudflare R2 (`agent.package.redeven.com/agent-install-pkg/<tag>/...`) and updates `version.agent.redeven.com/v1/manifest.json`.
