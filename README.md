...
- Private Ops workflow handles Cloudflare R2 mirror sync (`agent-install-pkg/<tag>/...`) and version-manifest Worker deployment for `https://version.agent.redeven.com/v1/manifest.json`.
