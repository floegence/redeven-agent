...
- Terminal bell events can now raise per-session attention state. Hidden or inactive sessions get a tab marker, repeated bells are notification-throttled, and re-activating the session clears the pending attention marker.
